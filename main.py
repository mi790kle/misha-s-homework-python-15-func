...
def display_question(question_index):
    print(f"The question is {questions[question_index]}")
...
def get_user_choice():
    while True:
        ...
        if user_choice != "1" and user_choice != "2" and user_choice != "3" and user_choice != "4":
            print("Choice options are 1, 2, 3 and 4")
            continue
        return int(user_choice)

def user_answer_is_correct(question_index, user_choice, answers):
...
def remove_question(question_index, questions):
    questions.pop(question_index)
    return questions

def remove_answer(question_index, answers):
...
while True:
    ...
    if user_answer_is_correct(question_index, user_choice, answers):
        score += 1
    ...
    questions = remove_question(question_index, questions)
    # removes the answer for the removed question
    answers = remove_answer(question_index, answers)
